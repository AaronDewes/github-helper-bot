...
async function build(octokit, owner, repo, pr, callbackfn) {
    ...
    const jobId = helpers_1.randomHash(10);
    ...
    await isomorphic_git_1.default.clone({ fs: fs_1.default, http: node_1.default, dir: folderPath, url: prInfo.data.head.repo.clone_url });
    ...
    await isomorphic_git_1.default.checkout({ fs: fs_1.default, dir: folderPath, ref: prInfo.data.head.sha });
    await isomorphic_git_1.default.pull({ fs: fs_1.default, http: node_1.default, dir: folderPath, url: prInfo.data.base.repo.clone_url, ref: 'master' });
    await isomorphic_git_1.default.branch({ fs: fs_1.default, dir: folderPath, ref: buildBranch });
    await isomorphic_git_1.default.checkout({ fs: fs_1.default, dir: folderPath, ref: buildBranch });
