...
exports.getPRs = exports.hasPushAccess = exports.labelExists = exports.ensureLabelExists = exports.closeIssue = exports.addLabel = exports.comparePRList = exports.repoExists = exports.randomHash = void 0;
...
function buildQuery(after) {
    return `
  {
    search(query: "org:getumbrel is:pr is:open draft:false", type: ISSUE, first: 100, ${after ? 'after: ' + after : ''}) {
      pageInfo { 
        hasNextPage
        endCursor
      }
